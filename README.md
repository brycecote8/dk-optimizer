...
Closing only the browser tab leaves the app running with whatever version it
started with; the launcher stops any old copy before starting, so
double-clicking it always gives you the latest version.
